...
pin_10 = board.get_pin('d:10:i') #iti
pin_40 = board.get_pin('d:40:i') #0
pin_41 = board.get_pin('d:41:i') #90
pin_42 = board.get_pin('d:38:i') #45
...
visualGratings = visual.GratingStim(win, tex='sin', size=[800,600], sf=sf, ori=0)
